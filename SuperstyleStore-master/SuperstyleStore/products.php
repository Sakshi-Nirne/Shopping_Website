...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Superstyle store!</h1>
           ...
           <footer class="footer">
               <div class="container">
               <center>
                   <p>All Rights Reserved. | Contact Us: +91 90000 00000</p>
                   <p>This website is developed by Sakshi Nirne</p>
               </center>
               </div>
           </footer>
        </div>
